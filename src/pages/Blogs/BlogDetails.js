...
const BlogDetails = () => {
  ...
  const { title, body, img, date, tags } = data
  useTitle(title)
  // const handleDelete = () => {
  ...
  return (
    <section className="mt-16 mb-20 relative">
      <Link
        to="/blogs"
        className="border-[1px] border-accent hover:border-primary rounded-full icon px-3 py-2 fixed right-10 top-32"
      >
        <lord-icon
      ...
      <p
        className="text-justify text-accent text-[17px] mt-6"
